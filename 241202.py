...
def setup_GUI():
    ...
    sub_btn = t.Button(window, text='-', width=5, height=2, font='Arial 15', command=lambda: press('-'))

    mul_btn = t.Button(window, text='*', width=5, height=2, font='Arial 15', command=lambda: press('*'))

    div_btn = t.Button(window, text='/', width=5, height=2, font='Arial 15', command=lambda: press('/'))
